...
from core.utils.pdf_utils import get_links_from_pdf, get_context
...
class TestPdfUtils:
    @patch("core.utils.pdf_utils.open")
    ...
    @patch("core.utils.pdf_utils.open")
    @patch("core.utils.pdf_utils.logger")
    ...
    @patch("core.utils.pdf_utils.get_links_from_pdf")
